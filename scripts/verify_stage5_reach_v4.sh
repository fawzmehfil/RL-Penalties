...
"$UNITY" \
  ...
  -logFile "$PROJECT_ROOT/docs/stage5-reach-v4-prepare.log"
...
"$UNITY" \
  ...
  -testResults "$PROJECT_ROOT/docs/stage5-reach-v4-editmode-results.xml" \
  -logFile "$PROJECT_ROOT/docs/stage5-reach-v4-editmode.log"
...
"$UNITY" \
  ...
  -testResults "$PROJECT_ROOT/docs/stage5-reach-v4-playmode-results.xml" \
  -logFile "$PROJECT_ROOT/docs/stage5-reach-v4-playmode.log"
...
"$UNITY" \
  ...
  -logFile "$PROJECT_ROOT/docs/stage5-reach-v4-macos-build.log"

echo "Stage 5.4 verification and build passed."
