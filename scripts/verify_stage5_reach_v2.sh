...
"$UNITY" \
  ...
  -logFile "$PROJECT_ROOT/docs/stage5-reach-v2-prepare.log"
...
"$UNITY" \
  ...
  -testResults "$PROJECT_ROOT/docs/stage5-reach-v2-editmode-results.xml" \
  -logFile "$PROJECT_ROOT/docs/stage5-reach-v2-editmode.log"
...
"$UNITY" \
  ...
  -testResults "$PROJECT_ROOT/docs/stage5-reach-v2-playmode-results.xml" \
  -logFile "$PROJECT_ROOT/docs/stage5-reach-v2-playmode.log"
...
"$UNITY" \
  ...
  -logFile "$PROJECT_ROOT/docs/stage5-reach-v2-macos-build.log"

echo "Stage 5.2 verification and build passed."
