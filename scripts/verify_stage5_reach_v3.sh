...
"$UNITY" \
  ...
  -logFile "$PROJECT_ROOT/docs/stage5-reach-v3-prepare.log"
...
"$UNITY" \
  ...
  -testResults "$PROJECT_ROOT/docs/stage5-reach-v3-editmode-results.xml" \
  -logFile "$PROJECT_ROOT/docs/stage5-reach-v3-editmode.log"
...
"$UNITY" \
  ...
  -testResults "$PROJECT_ROOT/docs/stage5-reach-v3-playmode-results.xml" \
  -logFile "$PROJECT_ROOT/docs/stage5-reach-v3-playmode.log"
...
"$UNITY" \
  ...
  -logFile "$PROJECT_ROOT/docs/stage5-reach-v3-macos-build.log"

echo "Stage 5.3 verification and build passed."
